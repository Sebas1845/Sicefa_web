...
@section('content')
                                ...
                                @foreach ($permissions as $permission)
                                    ...
                                    <div class="modal fade" id="validateModal{{ $permission->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form method="POST"
                                                    action="{{ route('sigac.instructor.PermissionValidation.store') }}"
 ...
 <div class="modal fade" id="evidenceModal" tabindex="-1" aria-labelledby="evidenceModalLabel" aria-hidden="true">
    ...
    {{-- Scripts: sin incluir externos (usa los del master). --}}
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        /* ------------------------------------------------------------
         🔹 VISUALIZAR EVIDENCIA (modal con imagen o PDF)
        ------------------------------------------------------------ */
        ...
        if (evidenceButtons && evidenceModal && evidenceContainer) {
            evidenceButtons.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Simula pequeña espera (mejor UX visual)
                    setTimeout(() => {
                        if (evidenceUrl.match(/\.(jpeg|jpg|png|gif|webp|bmp)$/i)) {
                            // 🖼️ Mostrar imagen
                            evidenceContainer.innerHTML = `
            ...
            // Limpia el contenido al cerrar el modal
        ...
        /* ------------------------------------------------------------
         🔹 VALIDACIÓN DE PERMISOS (manteniendo tu estructura original)
        ------------------------------------------------------------ */
        @foreach ($permissions as $permission)
            (function() {
                ...
                // Confirmación antes de enviar validación
                if (formValidate) {
                ...
                // Confirmación antes de cancelar validación
                if (formCancel) {
                    formCancel.addEventListener('submit', function(e) {
                        e.preventDefault();
                        const confirmCancel = () => formCancel.submit();
