    ...
    <div class="container py-5">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form method="GET" action="{{ route('sigac.wellness.PermissionValidation.wellnessValidationHistory') }}">
            ...
            @else
                ...
                <div class="modal fade" id="validateModal{{ $validation->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form method="POST"
                                action="{{ route('sigac.wellness.PermissionValidation.wellnessUpdateValidation', $validation->id) }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ==================== MANEJO DE MODAL DE EVIDENCIA ====================
        const evidenceModal = document.getElementById('evidenceModal');
        const evidenceContainer = document.getElementById('evidenceContainer');

        // Evento de Bootstrap: se dispara cuando se abre el modal
        evidenceModal.addEventListener('show.bs.modal', function(event) {
            ...
            const evidenceUrl = button?.getAttribute('data-evidence'); // Ruta de la evidencia
            ...
            if (!evidenceUrl) {
                evidenceContainer.innerHTML = '<p class="text-muted mt-3">No se encontró la evidencia.</p>';
                return;
            }
            ...
            if (['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp'].includes(extension)) {
                contentHTML = `<img src="${evidenceUrl}" alt="Evidencia" class="img-fluid rounded shadow">`;
            } else if (extension === 'pdf') {
                contentHTML = `<iframe src="${evidenceUrl}" width="100%" height="600px" frameborder="0"></iframe>`;
            } else {
                contentHTML = `<p class="text-muted mt-3">Tipo de archivo no soportado.</p>`;
            }

            // Mostrar evidencia después de pequeño delay
            setTimeout(() => {
                evidenceContainer.innerHTML = contentHTML;
            }, 300);
        });
        ...
        forms.forEach(form => {
            ...
            // Cambiar etiqueta según selección
