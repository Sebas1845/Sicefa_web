                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (Auth::user()->havePermission('sigac.academic_coordination.curriculum_planning.training_project.index'))
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview items">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('sigac.academic_coordination.reports.ficha.form') }}"
                                            class="nav-link">
                                            <i class="nav-icon fas fa-file-invoice"></i>
                                            <p>Cronogramas</p>
                                        </a>
                    ...
                    @if (Route::is('sigac.securitypersonnel.*'))
                        ...
                        @if (Auth::user()->havePermission('sigac.securitypersonnel.dashboard'))
                            ...
                            @if (Auth::user()->havePermission('sigac.securitystaff.visits.today'))
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="nav-icon fas fa-book"></i>
                                        <p>
                                    ...
                                    <ul class="nav nav-treeview items">
                                        <li class="nav-item">
                                            <a href="{{ route('sigac.securitystaff.visits.today') }}"
                                                class="nav-link">
                                                <i class="nav-icon fas fa-file-invoice"></i>
                                                <p>Visitas del dia</p>
                                            </a>
