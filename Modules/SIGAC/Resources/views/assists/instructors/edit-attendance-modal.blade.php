    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow-lg border-0 rounded-4">
            ...
            <form id="editAttendanceForm" method="POST"
                action="{{ route('sigac.instructor.attendancesrecord.update') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light" id="apprenticeName" readonly>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <input type="date" class="form-control" name="attendance_date" readonly
                                value="{{ $fecha->format('Y-m-d') }}">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Hora</label>
                            <input type="time" class="form-control" id="attendanceTime" name="attendance_time"
                                required
                                @if (!empty($currentRange)) min="{{ substr($currentRange['start'], 0, 5) }}"
        max="{{ substr($currentRange['end'], 0, 5) }}" @endif>
