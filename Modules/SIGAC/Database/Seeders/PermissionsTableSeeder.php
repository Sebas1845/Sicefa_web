...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // AJAX: Consultar veredas por municipio (Instructor)
        $permission = Permission::updateOrCreate(
            ['slug' => 'sigac.instructor.programming.program_request.searchvillages'],
            [
                'name' => 'Consultar veredas por municipio (Instructor)',
                'description' => 'Permite consultar veredas filtradas por municipio para la solicitud de programa',
                'description_english' => 'Allows querying villages filtered by municipality for program request',
                'app_id' => $app->id,
            ]
        );
        ...
        // AJAX: Consultar veredas por municipio (Coordinación Académica)
        $permission = Permission::updateOrCreate(
            ['slug' => 'sigac.academic_coordination.programming.program_request.searchvillages'],
            [
                'name' => 'Consultar veredas por municipio (Coordinación Académica)',
                'description' => 'Permite consultar veredas filtradas por municipio para la solicitud de programa',
                'description_english' => 'Allows querying villages filtered by municipality for program request',
                'app_id' => $app->id,
            ]
        ...
        // AJAX: Consultar veredas por municipio (CAMPESENA)
        $permission = Permission::updateOrCreate(
            ['slug' => 'sigac.campesena.programming.program_request.searchvillages'],
            [
                'name' => 'Consultar veredas por municipio (CAMPESENA)',
                'description' => 'Permite consultar veredas filtradas por municipio para la solicitud de programa',
                'description_english' => 'Allows querying villages filtered by municipality for program request',
                'app_id' => $app->id,
            ]
        ...
        //----------------------------securitystaff---------------------------------
        // Ver lista de personas de la visita (Coordinación Académica)
        $permission = Permission::updateOrCreate(['slug' => 'sigac.securitystaff.visits.today'], [
            'name' => 'Ver el listado de las visita (Personal de Seguridad)',
            'description' => 'Permite ver las visita dle dia',
            'description_english' => 'Allows you to see the day visits (security personnel)',
            'app_id' => $app->id,
        ]);
        $permissions_academic_coordination[] = $permission->id;
