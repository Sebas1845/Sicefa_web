...
Route::middleware(['lang'])->group(function () { //Middleware que permite la internacionalizacion
    ...
    Route::prefix('sigac')->group(function () {  // agrega el prefijo en la url (sicefa.test/sigac/...)
        ...
        Route::controller(ProgrammeController::class)->group(function () {
            ...
            // Público
            Route::get('public/course/{code}/apprentices', 'publicCourseApprentices')->name('cefa.sigac.public.course.apprentices');
            ...
            Route::post('wellness/programming/external_activities/approved', 'approved_external_activities')->name('sigac.wellness.programming.external_activities.approved');
            Route::post('wellness/programming/external_activities/cancel', 'cancel_external_activities')->name('sigac.wellness.programming.external_activities.cancel');
            ...
            Route::get('campesena/programming/program_request/table', 'program_request_table')->name('sigac.campesena.programming.program_request.table');
            Route::get('support/programming/program_request/table', 'program_request_table')->name('sigac.support.programming.program_request.table');
            ...
            Route::get('campesena/programming/program_request/index', 'program_request_index')->name('sigac.campesena.programming.program_request.index');
            ...
            Route::post('campesena/programming/program_request/store', 'program_request_store')->name('sigac.campesena.programming.program_request.store');
            ...
            Route::get('campesena/programming/program_request/searchperson', 'program_request_searchperson')->name('sigac.campesena.programming.program_request.searchperson');
            ...
            Route::get('campesena/programming/program_request/searchprofession', 'program_request_searchprofession')->name('sigac.campesena.programming.program_request.searchprofession');
            ...
            Route::get('campesena/programming/program_request/searchempresa', 'program_request_searchempresa')->name('sigac.campesena.programming.program_request.searchempresa');
            ...
            Route::get('campesena/programming/program_request/searchvillages', 'program_request_searchvillages')->name('sigac.campesena.programming.program_request.searchvillages');
            ...
            Route::post('campesena/programming/program_request/storevillages', 'program_request_storevillages')->name('sigac.campesena.programming.program_request.storevillages');
            ...
            Route::get('campesena/programming/program_request/searchapplicant', 'program_request_searchapplicant')->name('sigac.campesena.programming.program_request.searchapplicant');
            ...
            Route::post('campesena/programming/program_request/{id}/approve', 'program_request_approve')->name('sigac.campesena.programming.program_request.approve');
            ...
            Route::post('campesena/programming/program_request/{id}/devolve', 'program_request_devolve')->name('sigac.campesena.programming.program_request.devolve');
            ...
            Route::post('campesena/programming/program_request/{id}/reject', 'program_request_reject')->name('sigac.campesena.programming.program_request.reject');

            // dismiss (si lo usas así)
            ...
            Route::post('campesena/programming/program_request/document_store/{id}', 'program_request_document_store')->name('sigac.campesena.programming.program_request.document_store');
            Route::post('support/programming/program_request/document_store/{id}', 'program_request_document_store')->name('sigac.support.programming.program_request.document_store');
            ...
            Route::get('program_request/{pr}/document/{doc}/view', 'program_request_document_view')->name('sigac.programming.program_request.document.view');

            Route::get('program_request/{pr}/document/{doc}/download', 'program_request_document_download')->name('sigac.programming.program_request.document.download');
