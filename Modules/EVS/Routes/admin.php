...
use Modules\EVS\Http\Controllers\Admin\DashboardController;
use Modules\EVS\Http\Controllers\Admin\JuriesController;
...
Route::middleware(['lang'])->group(function () {
	...
	Route::prefix('evs/admin')->group(function() {
		...
		//Route::namespace('Modules\EVS\Http\Controllers')->group(function () {
			//ruta del Dashboard
	Route::get('/dashboard', action: 'Admin\DashboardController@getDashboard')->name('evs.admin.dashboard');
			//rutas de eventos
			...
			Route::post('/election/add/store','Admin\ElectionsController@postElectionAdd')->name('evs.admin.elections.add.post');
			...
			Route::get(uri: '/election/delete/{id}',action: 'Admin\ElectionsController@getElectionDelete')->name('evs.admin.elections.delete');
			//rutas de candidates
			Route::get('/candidates',action: 'Admin\CandidatesController@getCandidates')->name('evs.admin.candidates');
			Route::get('/candidates/add/{id}','Admin\CandidatesController@getCandidatesAdd')->name('evs.admin.candidates.add');
			Route::post('/candidates/search/{id}',action: 'Admin\CandidatesController@postCandidatesSearch')->name('evs.admin.candidates.search');
			Route::post('/candidates/add/post','Admin\CandidatesController@postCandidateAdd')->name('evs.admin.candidates.add.post');
			...
			Route::get('/excel/autorizaciones', 'Admin\JuriesController@excel_autorizaciones')->name('cefa.evs.excel_autorizaciones');
