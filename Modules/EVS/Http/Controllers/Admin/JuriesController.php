...
public function excel_autorizaciones()
{
    ...
    foreach ($usuarios as $person) {
        ...
        if (!$authorized) {
            ...
            $authorized->jury_id = 17; // ⚠️ si tienes el jurado en sesión, úsalo: session('jury_id')
        ...
        $data[] = [
            ...
            'numero_ficha'          => $person->apprentices[0]->course->code,
