...
class GenerateSale extends Component
{
    ...
    // Nueva propiedad para controlar dinámicamente el input de cantidad
    public $enable_amount_input = false;
    ...
    public function defaultAction(){
        ...
        $this->enable_amount_input = false; // Deshabilitar input al inicio
    ...
    public function updatedProductId(){
        if(empty($this->product_id)){
            ...
            $this->enable_amount_input = false;
            $this->emit('enable-amount-input', false);
            ...
            $this->enable_amount_input = true; // Habilitar input de cantidad
            $this->emit('enable-amount-input', true);
    ...
    public function resetValues(){
        ...
        $this->enable_amount_input = false; // Deshabilitar al reset
        $this->emit('enable-amount-input', false);
        $this->totalValueProducts(); // Calcular el valor total de los productos seleccionados
    }
