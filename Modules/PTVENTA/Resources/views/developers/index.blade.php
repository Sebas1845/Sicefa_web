...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h3 class="text-center mt-2">{{ trans('ptventa::devs.Title_Developers') }}</h3>
                <div class="card-body">
                    <div class="container text-center">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 mb-4" data-aos="zoom-in">
                                <img class="bd-placeholder-img rounded-circle" src="{{ asset('modules/ptventa/images/developers/Mauro_Dev_386.png') }}" alt="MauroProfile" width="140" height="140">
                                <h4>{{ trans('ptventa::devs.Description_Apprentice') }}</h4>
                    ...
                    <div class="d-flex justify-content-center">
                        <a class="btn" id="scrollButton">
                            <h5>{{ trans('ptventa::devs.View credits') }}</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="600" style="height: 200px;">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/php.webp') }}" alt="PHP-logo" style="width: 100px; height: 100px;">
                                    </div>
                                    <div class="text-truncate" style="max-height: 40px;">
                                        <h6>PHP</h6>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="500" style="height: 200px;">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/toastr-js.webp') }}" alt="Toastr-logo" style="width: 100px; height: 100px;">
                                    </div>
                                    <div class="text-truncate" style="max-height: 40px;">
                                        <h6>Toastr-Js</h6>
                                    </div>
                                    <a class="btn btn-success btn-block w-100" href="https://codeseven.github.io/toastr/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card text-center" data-aos="zoom-in-up" data-aos-duration="800" style="height: 200px;">
                                <div class="card-body d-flex flex-column justify-content-between">
                                    <div class="align-self-center">
                                        <img src="{{ asset('modules/ptventa/images/sponsor/Visual_Studio_Code.webp') }}" alt="VSCode-logo" style="width: 100px; height: 100px;">
                                    </div>
                                    <div class="text-truncate" style="max-height: 40px;">
                                        <h6>VSCode</h6>
                                    </div>
                                    <a class="btn btn-success btn-block w-100" href="https://code.visualstudio.com/">{{ trans('ptventa::devs.More Info') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
